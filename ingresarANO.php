...
<!-- <div class="col-md-5" style="align-content: right;">
 ...
 <form action="insertarANO.php" method="POST">

<label for="id_ano_acad">ID</label>
<input type="text" class="form-control mb-3" name="id_ano_acad">

<label for="nom_ano_acad">AÑO</label>
<input type="text" class="form-control mb-3" name="nom_ano_acad">
